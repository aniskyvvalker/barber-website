...
// Small, strict escape helper to avoid HTML injection
...
router.post("/api/send-email", async (req, res) => {
    try {
        ...
        // Require an API key for callers. Accept `x-api-key` header or `Authorization: Bearer <key>`.
