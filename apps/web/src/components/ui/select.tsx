      ...
      {!hideIcon && (
        <SelectPrimitive.Icon asChild>
          <ChevronDown className={cn(
            "opacity-60",
            iconFixed ? "absolute right-2 top-1/2 -translate-y-1/2 size-3" : "size-4"
          )} />
