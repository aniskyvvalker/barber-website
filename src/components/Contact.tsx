            ...
            <Card className="mb-6">
              <CardContent className="pt-6">
                ...
                <div className="mt-6 pt-6 border-t border-border">
                  <p className="mb-4">Book via WhatsApp or follow us:</p>
                  <div className="flex flex-wrap gap-3">
                    <Button 
                      variant="outline" 
                      size="sm"
                      className="hover:bg-accent hover:text-white transition-colors"
                      onClick={() => window.open('https://wa.me/213553552209', '_blank')}
                    >
                    ...
                    <Button 
                      ...
                      size="sm"
                      className="hover:bg-accent hover:text-white transition-colors"
                      onClick={() => window.open('https://www.instagram.com/imperialcut.dz/', '_blank')}
                    >
                    ...
                    <Button 
                      ...
                      size="sm"
                      className="hover:bg-accent hover:text-white transition-colors"
                      onClick={() => window.open('https://www.tiktok.com/@imperialcut.dz', '_blank')}
                    >
              ...
              <CardContent className="pt-6">
                  ...
                  {openingHours.map((item, index) => (
                    <div
                      ...
                      className={`flex justify-between py-3 border-b border-border/50 last:border-0 ${
                        item.hours === 'Closed' ? 'text-muted-foreground' : ''
                      }`}
                    >
                      <span className={item.day === 'Friday' ? 'text-accent' : ''}>
                        {item.day}
                      </span>
                ...
                <div className="mt-6 pt-6 border-t border-border">
                  <p className="text-sm text-muted-foreground">
                    Walk-ins welcome, but appointments are recommended to avoid wait times.
                  </p>
                </div>
              </CardContent>
            </Card>
