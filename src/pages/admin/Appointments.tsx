...
export default function Appointments() {
    ...
    const filteredAppointments = appointments.filter((apt) => {
        ...
        if (dateFilter === "today" && aptDate.getTime() !== today.getTime())
            return false;
            ...
            <div className="mb-6">
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <Select
                        ...
                        <SelectTrigger
                            className="admin-filter-trigger w-28 md:w-28 shrink-0 border border-gray-300 rounded-md bg-white outline-none focus:outline-none ring-0 focus:ring-0 focus-visible:ring-0 ring-offset-0 focus-visible:ring-offset-0 data-[state=open]:ring-0 data-[state=open]:ring-offset-0 hover:border-gray-300 focus:border-gray-400"
                            style={{ backgroundColor: "#ffffff" }}>
                ...
                <CardContent className="p-0" style={{ padding: 0 }}>
                    {loading ? (
                        ...
                        <div className="overflow-x-auto">
                            <table className="appointments-table text-center" style={{ minWidth: 900 }}>
                                <thead>
                                ...
                                <tbody>
                                    {filteredAppointments.map((apt) => (
                                        <tr
                                            ...
                                            <td
                                                className="py-4 px-4 text-center text-gray-900"
                                                style={{ textAlign: "center" }}>
                                                <div className="w-max mx-auto text-center">
