                ...
                <CardContent className="p-0" style={{ padding: 0 }}>
                    {loading ? (
                        ...
                        <div
                            ...
                            <table
                                className="appointments-table w-full text-left"
                                style={{ minWidth: 1100 }}>
                                <thead
                                    className="bg-[#F9FAFB]"
                                    style={{ backgroundColor: "#F9FAFB" }}>
                                ...
                                <tbody>
                                    {filteredAppointments.map((apt) => (
                                        <tr
                                            ...
                                            <td
                                                className="py-4 px-6 text-left text-gray-900"
                                                style={{ textAlign: "left" }}>
                                                <div
                                                    className="w-full text-left"
                                                    style={{
                                                    ...
                                                    {(() => {
                                                        return (
                                                            <Select
                                                                ...
                                                                <SelectTrigger
                                                                    hideIcon
                                                                    className="inline-flex w-auto border-0 bg-transparent p-0 cursor-pointer outline-none focus:outline-none ring-0 focus:ring-0 focus-visible:ring-0 ring-offset-0 focus-visible:ring-offset-0 shadow-none data-[state=open]:ring-0 data-[state=open]:ring-offset-0">
                                                                    <span
                                                                        className={`inline-flex items-center justify-between gap-1 px-3 py-1 rounded-md text-xs font-medium border`}
                                                                        style={{
                                                                            ...getStatusStyle(
                                            ...
                                            <td
                                                ...
                                                <a
                                                    href="#"
                                                    role="button"
                                                    className="appointments-view-link underline underline-offset-2 focus:outline-none"
                                                    style={{
                                                        fontWeight: 500,
                                                        WebkitTextStroke:
                                                            "0.3px currentColor",
